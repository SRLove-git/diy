...
import 'package:diy_ui_app/custom_widget/CustomWidget_5_50433.dart';
import 'package:diy_ui_app/custom_widget/CustomWidget_5_50498.dart';

class Frame_5_50432 extends StatefulWidget {

  Frame_5_50432({super.key,});
  @override
  State<Frame_5_50432> createState() => _Frame_5_50432State();
}

class _Frame_5_50432State extends State<Frame_5_50432> {
  late final ImageProvider _image_rggk5_50458 = MemoryImage(imageStr_imageStr_jprl5_50458.decodeBase64Image());
  late final ImageProvider _image_mjor5_50472 = MemoryImage(imageStr_imageStr_ioeh5_50472.decodeBase64Image());
  late final ImageProvider _image_dukl5_50486 = MemoryImage(imageStr_imageStr_nmnp5_50486.decodeBase64Image());
  late final ImageProvider _image_wcgi5_50498 = MemoryImage(imageStr_imageStr_rcep5_50498.decodeBase64Image());
        ...
        child: SizedBox(
            ...
            child: ListView(
              children: [
                ...
                child: Stack(
                  key: ValueKey("5:50432"),
                  children: [
                    CustomWidget_5_50433(),
                    CustomWidget_5_50498(),
                    Positioned(
                      width: 390.w,
                      height: 68.h,
                      left: 0.w,
